                ...
                <form action="{{ route('user.update', ['user' => $user->getKey()]) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                            id="email-input" value="{{ old('email', $user->email) }}">
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" id="role"
                            ...
                            @foreach ($roles as $item)
                                <option value="{{$item}}" @selected(old('role', $item == $user->role))>{{ str($item)->title() }}</option>
                            @endforeach
                        </select>
                        @error('role')
                            <div class="invalid-feedback">
